...
[![Build Status](https://builds.gbif.org/job/hp-czech-virtual-herbarium/badge/icon)](https://builds.gbif.org/job/hp-czech-virtual-herbarium/lastBuild/console)
...
# GBIF Hosted Portal: czech-virtual-herbarium

This Jekyll website, **[czech-virtual-herbarium (Staging)](https://czech-virtual-herbarium.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
